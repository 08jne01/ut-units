...
This makes it easy to interface with existing code that does not use units. See the [quantity page](https://08jne01.github.io/ut-units/quantity.html) for more.
...
See the [units page](https://08jne01.github.io/ut-units/units.html) for more.
